...
@Singleton
class UserRepository @Inject()(dbConfigProvider: DatabaseConfigProvider, implicit val ec: ExecutionContext, val classTag: ClassTag[PasswordInfo]) extends IdentityService[User] {
