...
@Singleton
class PreservesController @Inject()(cc: MessagesControllerComponents, preservesService: PreservesService, common: Common) extends MessagesAbstractController(cc) {
